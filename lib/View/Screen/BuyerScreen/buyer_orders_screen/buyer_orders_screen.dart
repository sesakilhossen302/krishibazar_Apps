              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Text(
                        'আমার ক্রয় ও অর্ডারসমূহ (${_toBnDigits(myOrders.length)} টি)',
                  ...
                  const Text(
                    'ডেলিভারি ও এসক্রো পেমেন্ট ট্র্যাক করুন',
                    style: TextStyle(
                      fontSize: 13,
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const Text(
                                  'কৃষকের অফার গ্রহণ করলে অথবা চাহিদা চূড়ান্ত হলে এখানে অর্ডার প্রদর্শিত হবে।',
